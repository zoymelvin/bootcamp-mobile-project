# Kesimpulan Penggunaan GitHub dalam Proyek Tim

Menurut pandangan saya, penggunaan Git dan GitHub bukan hanya sekadar untuk menyimpan *backup* kode secara online. Fungsi utamanya adalah untuk mengatur alur kerja (workflow) tim agar tidak berantakan.

Beberapa poin penting yang saya pelajari:

* **Menghindari Konflik:** Fitur **Branch** (cabang) sangat berguna. Setiap anggota tim bisa bekerja di *branch* mereka sendiri tanpa mengganggu kode utama di *branch* `main`. Ini menjaga agar kode utama tetap stabil dan berfungsi.
